...
if __name__ == "__main__":
  ...
  while True:
    for duty in range(0, 40, 1):   # slow to fast
      board.motor_movement([board.M1], board.CCW, duty)    # DC motor 1 movement, orientation clockwise
      board.motor_movement([board.M2], board.CW, duty)   # DC motor 2 movement, orientation count-clockwise
      time.sleep(1)
    ...
    for duty in range(40, 0, - 1):   # fast to low
      board.motor_movement([board.M1], board.CCW, duty)    # DC motor 1 movement, orientation clockwise
      board.motor_movement([board.M2], board.CW, duty)   # DC motor 2 movement, orientation count-clockwise
      time.sleep(1)
      speed = board.get_encoder_speed(board.ALL)      # Use boadrd.all to get all encoders speed
